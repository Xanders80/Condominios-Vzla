    ...
    <div class="panel-body">
        <div class="row"> {{-- - Código & Nombre & Activo- --}}
            <div class='form-group col-2'>
                <x-input-text name="code_sudebank" label="{{ trans('Code Sudeban') }}"
                    plHolder="{{ trans('Type here...') }}" icon="mdi mdi-barcode " id="code_sudebank" isRequired=true
                    autofocus />
            </div>

            <div class='form-group col-8'>
                <x-input-text name="name_ibp" label="{{ trans('Name') }}" plHolder="{{ trans('Type here...') }}"
                    icon="mdi mdi-bank " id="name_ibp" isRequired=true autofocus />
            </div>
        ...
        <div class="row"> {{-- - Rif - --}}
            ...
            <div class='form-group col-9'> {{-- - Website - --}}
                <x-input-text name="website" label="{{ trans('Web Site') }}" plHolder="{{ trans('Type here...') }}"
                    icon="mdi mdi-web " id="website" isRequired=true autofocus />
            </div>
        </div>
    </div>
</div>
