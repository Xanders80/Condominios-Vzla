...
namespace App\Http\Controllers\Backend\DocumentType;
...
class DocumentTypeController extends Controller
{
    ...
    public function destroy($id)
    {
        try {
            ...
            Log::error('Error fn(DocumentTypeController) destroy', [
    ...
    /**
     * Maneja el almacenamiento o actualización de un documento.
     *
     * @param int|null $id
     *
     * @return \Illuminate\Http\JsonResponse
