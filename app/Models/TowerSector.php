...
class TowerSector extends Model
{
    use HasFactory;
    use HasUuids;
    use SoftDeletes;

    protected $fillable = ['id', 'name', 'description', 'condominiums_id'];
    protected $casts = [];
    protected $table = 'tower_sectors';
    ...
    public static function validationRules(array $data)
    {
        return Validator::make($data, [
            'name' => 'required|unique:tower_sectors,name',
